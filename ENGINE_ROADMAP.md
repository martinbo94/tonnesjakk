...
| 4v2 / 2v4 | 44.84B valid states (both sides to move) → **11.2 GB packed** | **4 h 04 min** (22 passes, 12 threads, ~15 GB RSS, lowmem) | side with 2 left wins **91.5 %**, side with 4 wins 5.6 %, **draws 2.9 %** (most drawish phase). 2v4 answered via the colour mirror. One-ply consistency 0/300 (both orientations). **Every position with ≤ 7 barrels remaining is now solved.** |
