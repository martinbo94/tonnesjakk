...
python scripts/nnue_tournament.py --preset round7 \
  ...
  --out runs/gen123_r7 --epochs 100 --games 600 --time 100 --workers "${WORKERS:-10}" \
...
python scripts/ladder.py --candidate "runs/gen123_r7/$WINNER/nnue_weights.json" --label "net4_$WINNER" --time 100 --games 600 --workers "${WORKERS:-10}"
